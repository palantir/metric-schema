...
import com.palantir.metric.schema.grafana.DashboardConfig;
...
@CacheableTask
public class GenerateMetricGrafanaTask extends DefaultTask {
    ...
    public final void generate() throws IOException {
        ...
        GFileUtils.writeFile(
                GrafanaRenderer.render(dashboardConfig, schemas.values().stream()
                        .flatMap(List::stream)
