...
public enum DashboardStyle {
    ...
    private static final Map<String, DashboardStyle> ENUM_MAP;

    static {
        Map<String, DashboardStyle> map = new ConcurrentHashMap<>();
        for (DashboardStyle value : DashboardStyle.values()) {
    ...
    @JsonCreator
    public static DashboardStyle fromString(String name) {
